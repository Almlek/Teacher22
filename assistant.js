/* ═══════════════════════════════════════════════════════
   assistant.js — المساعد الذكي لتطبيق "الهائل"
...
(function () {
  ...
  const APP_KNOWLEDGE = `
أنت "المساعد الذكي" المدمج داخل تطبيق "الهائل" — منظومة تعليمية متكاملة ودفتر تحضير ذكي للمعلمين، يعمل بدون إنترنت (PWA)، ويستخدم Gemini API لتوليد المحتوى.
